        ...
        <div class="modal-content">
            <form class="" id="formData" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Content</label>
                        <textarea id="ckeditor"  name="content" class="form-control" placeholder="Description about" required></textarea>
                        <div class="invalid-feedback">
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
 "use strict";
    ...
    var apiGrid = API_URL + "keks";
    var apiAdd = API_URL + "kek/add";
    var apiEdit = API_URL + "kek/edit";
    var apiDelete = API_URL + "kek/delete";
    var apiGet = API_URL + "kek/get/";
    ...
    $(document).ready(function() {
        ...
        $("button.add_modal").click(function(e) {
            ...
            clearForm();
            formState = "add";
            $("#formModal" + " .modal-title").html('Add New Info Covid');
                    ...
                    for (const key in data) {
                        if (data.hasOwnProperty(key)) {
                            ...
                            if (key == "content" && element != null) {
                                CKEDITOR.instances['ckeditor'].setData(element);
